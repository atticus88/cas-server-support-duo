package edu.weber.cas.duo.config;

/**
 * CasConstants defines several String constants that are used by {@link UsernamePasswordAuthenticationMetaDataPopulator} and
 * {@link edu.weber.cas.duo.authentication.DuoAuthenticationMetaDataPopulator} when indicating whether the TGT was issued after
